...
public class formbeli extends javax.swing.JFrame {
  ...
  private void nofaktur() {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Toko Baju Fattah Busana");
    ...
    private void hitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hitungActionPerformed
        ...
        if(aa > bb){
             JOptionPane.showMessageDialog(null, "jumlah melebihi stok", "Toko Fattah Busana", JOptionPane.INFORMATION_MESSAGE);
             tjumlah.setText("");
        }else{
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if(faktur.getText().equals("") ||kdbarang.getText().equals("") || pilihbarang.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")|| ttotal.getText().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "Toko fattah busana", JOptionPane.INFORMATION_MESSAGE);
            ...
            try {
                ...
                tjumlah.setText("");
                ttotal.setText("");
                JOptionPane.showMessageDialog(null, "Data berhasil disimpan", "Toko fattah busana", JOptionPane.INFORMATION_MESSAGE);
                loadData();
        ...
        // TODO add your handling code here:
         if(jTextField3.getText().equals("") ||jTextField1.getText().equals("")){
            ...
            int ab = Integer.parseInt(String.valueOf(jTextField1.getText()));
              if(ab < 0){
                JOptionPane.showMessageDialog(null, "Uang anda kurang", "Toko fattah busana", JOptionPane.INFORMATION_MESSAGE);
                jTextField3.setText("");
            jTextField1.setText("");
              }else{
           try {
         ...
         try {
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "TRANSAKSI SELESAI", "Toko fattah busana", JOptionPane.INFORMATION_MESSAGE);
            loadData();
