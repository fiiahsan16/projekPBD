...
public class formregister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        peran.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih", "admin", "pegawai" }));
        peran.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                peranActionPerformed(evt);
            }
        });
        jPanel1.add(peran, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 110, 170, 30));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(jTextField1.getText().equals("") ||jPasswordField1.getText().equals("") || laki.getText().equals("")|| email.getText().equals("")|| notelp.getText().equals("")|| peran.getSelectedItem().equals("")|| alamat.getText().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "toko fattah jaya busana", JOptionPane.INFORMATION_MESSAGE);
        }else{
        try {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().equals("") ||jPasswordField1.getText().equals("") || laki.getText().equals("")|| email.getText().equals("")|| notelp.getText().equals("")|| peran.getSelectedItem().equals("")|| alamat.getText().equals("")){
            ...
            String perana = (String) peran.getSelectedItem();
            ...
            try {
                ...
                email.setText("");
                notelp.setText("");
                peran.setSelectedItem("");
                alamat.setText("");

                JOptionPane.showMessageDialog(null, "Data berhasil tersimpan", "Toko Fattah busana", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            alamat.setText("");
            jButton1.setEnabled(true);
            JOptionPane.showMessageDialog(null, "Data berhasil diubah", "Toko fattah busana", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void tabelbarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelbarangMouseClicked
        ...
        String perana = (String) model.getValueAt(i, 5);
        peran.setSelectedItem(perana);
